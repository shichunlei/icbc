                      ...
                      child: Stack(children: [
                        ...
                        GestureDetector(
                            ...
                            child: Container(
                                ...
                                width: 40,
                                child:
                                    Image.asset("assets/images/detail/my_detail_suspend_layer_close.png", width: 25)))
                      ])),
                            ...
                            Expanded(
                                child: GestureDetector(
                                    ...
                                    child: Container(
                                        ...
                                        child: Text("近1月",
                                            style: TextStyle(
                                                color: logic.selectIndex.value == 0 ? Colors.white : null))))),
                            ...
                            Expanded(
                                child: GestureDetector(
                                    ...
                                    child: Container(
                                        ...
                                        child: Text("近3月",
                                            style: TextStyle(
                                                color: logic.selectIndex.value == 1 ? Colors.white : null))))),
                            const SizedBox(width: 10),
                            Expanded(
                                child: GestureDetector(
                                    onTap: () {
                                    ...
                                    child: Container(
                                        ...
                                        child: Text("近6月",
                                            style: TextStyle(
                                                color: logic.selectIndex.value == 2 ? Colors.white : null))))),
                            const SizedBox(width: 10),
                            Expanded(
                                child: GestureDetector(
                                    onTap: () {
                                    ...
                                    child: Container(
                                        ...
                                        child: Text("近12月",
                                            style: TextStyle(
                                                color: logic.selectIndex.value == 3 ? Colors.white : null))))),
                            const SizedBox(width: 15)
                          ]),
                          const SizedBox(height: 20),
                          Row(children: [
                                        ...
                                        child: Obx(() {
                                          return Text(
                                              logic.stopDate.value == null
                                                  ? "结束时间"
                                                  : DateUtil.getDateTimeFromDateTime(
                                                      logic.stopDate.value!, "yyyy-MM-dd"),
                                              style: const TextStyle(fontSize: 12));
                                        })))),
                            const SizedBox(width: 15)
                          ]),
