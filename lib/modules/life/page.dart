        ...
        body: Stack(children: [
          CustomScrollView(controller: logic.controller, slivers: [
                      ...
                      Positioned(
                          ...
                          child: Container(
                              ...
                              child: Column(children: [
                                ...
                                SizedBox(height: 18),
                                Row(children: [
                                  IconTextView(text: "美食兑换", imagePath: "assets/images/icons/icon_美食兑换.png"),
                                  IconTextView(text: "品质外卖", imagePath: "assets/images/icons/icon_品质外卖.png"),
                                  IconTextView(text: "积分专区", imagePath: "assets/images/icons/icon_积分专区.png"),
                                  IconTextView(text: "爱购8.8", imagePath: "assets/images/icons/icon_爱购8.8.png"),
                                  IconTextView(text: "全部", imagePath: "assets/images/icons/icon_全部.png", onTap: () {})
                                ])
                              ])))
                    ]))),
            SliverAppBar(
                ...
                flexibleSpace: FlexibleSpaceBar(
                    background: Container(
                        ...
                        child: Column(children: [
                          ...
                          SizedBox(height: 15),
                          Row(children: [
                            ImageCardView(text: "工银星礼遇", subText: "尽享丰富权益", imagePath: "assets/images/life/工银星礼遇.png"),
                            SizedBox(width: 10),
                            ImageCardView(text: "观影优惠季", subText: "立减折扣享不停", imagePath: "assets/images/life/观影优惠季.png")
                          ]),
                          SizedBox(height: 10),
                          Row(children: [
                            ImageCardView(
                            ...
                            SizedBox(width: 10),
                            ImageCardView(text: "节节侯新", subText: "悦享四时礼遇", imagePath: "assets/images/life/节节侯新.png")
                          ])
                        ])))),
            ...
            SliverToBoxAdapter(
                child: SizedBox(
                    height:
                        MediaQuery.of(context).size.height - kToolbarHeight - MediaQuery.of(context).padding.top - 50,
                    child: Column(children: [
                      Container(
                          padding: EdgeInsets.symmetric(horizontal: 10, vertical: 15),
                          ...
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            ...
                            Row(children: [
                              ImageCardView(
                                  text: "住房公积金", subText: "查询公积金明细", imagePath: "assets/images/life/住房公积金.png"),
                              SizedBox(width: 10),
                              ImageCardView(
                                  text: "长三角政务", subText: "汇聚政务 一网统办", imagePath: "assets/images/life/长三角政务.png")
                            ])
                          ])),
                      Container(
                          padding: EdgeInsets.symmetric(horizontal: 10, vertical: 15),
